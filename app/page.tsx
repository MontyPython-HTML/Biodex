  ...
  return (
    <div className='bg-background w-full h-screen'>
      ...
      <section id="topIcons" className='flex flex-col gap-5' color="white">
        <Link href="/"><House id="homeBtn" className='w-[39px] h-[39px] text-inverse-primary cursor-pointer hover:opacity-80' /></Link>          
        <Link href="/pet"><PawPrint id="petBtn" className='w-[39px] h-[39px] text-white cursor-pointer hover:opacity-80' /></Link>          
        <Link href="/inventory"><Box id="inventoryBtn" className='w-[39px] h-[39px] text-white cursor-pointer hover:opacity-80' /></Link>        
      </section>
        <section id="profile">
